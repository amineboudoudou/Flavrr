...
import { MenuItem, CartItem, Category, Language } from './types';
        ...
        const loadMenu = async () => {
            ...
            try {
                ...
                const fetchPromise = Promise.all([
                    api.publicListCategories(ORG_ID),
                    api.publicListMenuItems(ORG_ID)
                ]);
                ...
                const [cats, items] = await Promise.race([fetchPromise, timeoutPromise]) as [Category[], MenuItem[]];

                console.log(`✅ Loaded ${cats.length} categories and ${items.length} items.`);
